...
class CirculoFragment_bkp : Fragment() {
    ...
    override fun onCreateView(
        ...
        val circuloViewModel =
            ViewModelProvider(this).get(CirculoViewModel::class.java)

        _binding = FragmentCirculoBinding.inflate(inflater, container, false)
        val root: View = binding.root

        //val textView: TextView = binding.textNotifications
        //circuloViewModel.text.observe(viewLifecycleOwner) {
        //    textView.text = it
        //}
        return root
    }
